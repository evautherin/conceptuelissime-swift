...
//        let testPhases: [ScenePhase] = [.active, .inactive, .background, .inactive, .active]
...
//        #expect(observedStates == ["noSession", "noSession", "session", "noSession", "noSession"], "Session state transitions did not match expected pattern.")
//    }
}
